...
import imgSection05 from "figma:asset/eecb2d489176a1a678ae44a8b64429ec6412d3c7.png";
...
function Website() {
  return (
    ...
    >
      <div
        className="[background-size:100%_100%] bg-no-repeat bg-top-left h-0 shrink-0 w-[550px]"
      ...
      />
      <div
        className="[background-size:100%_100%] bg-no-repeat bg-top-left h-[93px] shrink-0 w-[550px]"
      ...
      />
      <div
        className="[background-size:100%_100%] bg-no-repeat bg-top-left h-[376px] shrink-0 w-[550px]"
        data-name="Section 05"
        style={{ backgroundImage: `url('${imgSection05}')` }}
      />
    </div>
  );
}

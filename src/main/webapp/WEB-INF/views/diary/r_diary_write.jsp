...
<html lang="ko">
  <head>
    ...
    <title>성찰일기 | 작성하기</title>
    <script src="https://unpkg.com/lucide@latest"></script>
	<script src="${pageContext.request.contextPath}/resources/assets/js/cmn/jquery.js"></script>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/assets/css/r_diary_write.css"/>
	...
	document.addEventListener("DOMContentLoaded", () => {
    	  ...
    	  // 일기 등록 버튼 이벤트
    	  document.getElementById("saverDiary").addEventListener("click", () => {
    ...
    <main class="container">
      ...
      <div class="card diary-card" style="margin-top: 20px">
        <div class="diary-st">
          ...
          <span class="diary-title-text">생각의 흔적</span>
        </div>
        ...
        <div class="diary-footer">
          ...
          <button class="diary-btn" id="saverDiary" type="button">등록</button>
        </div>
      </div>
    </main>
